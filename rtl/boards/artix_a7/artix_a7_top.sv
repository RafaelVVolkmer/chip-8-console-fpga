...
// artix_a7_top.sv
// -----------------------------------------------------------------------------
// @brief Board integration wrapper for Artix A7 board.
// =============================================================================
//
// Responsibilities:
...
module artix_a7_top #(
  parameter int CLK_HZ = artix_a7_pkg::ARTIX_A7_CLK_HZ,
  parameter int VIDEO_BACKEND = artix_a7_pkg::ARTIX_A7_VIDEO_BACKEND,
  ...
  always_ff @(posedge clk_100mhz_i) begin : heartbeat_ff
    if (!soc_rst_n) begin
      heartbeat_q <= '0;
    end else begin
  ...
  assign led_o = {dap_error, dap_busy, halted, heartbeat_q[25]};
